...
$classes = ($active ?? false)
            ? 'inline-flex items-center border-b-2 border-cyan-500 px-1 pt-1 text-sm font-semibold leading-5 text-slate-950 transition focus:outline-none focus:border-cyan-600'
