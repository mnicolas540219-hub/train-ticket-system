<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <p class="text-sm font-medium text-slate-500">Employee dashboard</p>
    ...
    <div class="bg-slate-100">
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <div class="divide-y divide-slate-100">
                        @forelse ($myReservations as $reservation)
                            <div class="px-5 py-4">
                                <div class="flex items-start justify-between gap-3">
                                    <div>
                                        <p class="font-semibold text-slate-950">
                                            @if ($reservation->seat_number && $reservation->seat_number !== 'Unassigned')
                                ...
                                <p class="mt-3 text-xs uppercase tracking-wide text-slate-400">{{ $reservation->created_at?->format('h:i A') }}</p>
                            </div>
                        @empty
            ...
            <!-- Ticket submission removed per request -->
        </div>
    </div>
</x-app-layout>
